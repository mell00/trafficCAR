...
roads <- sf::st_read(road_file, quiet = TRUE)
...
`plot_mcmc_diagnostics()` returns a data frame of effective sample size (ESS)
values for each parameter. You can visualize the output with ggplot2.

```{r, fig.width=7, fig.height=4}
ess_df <- plot_mcmc_diagnostics(fit)

ggplot(ess_df, aes(parameter, ess)) +
